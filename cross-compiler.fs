...
NAMED-WORDLIST CROSS-COMPILER-EXT CONSTANT CROSS-COMPILER-EXT-WORDLIST  \ colon cross-compiler
...
CROSS-COMPILER-EXT-WORDLIST PARSE-WORD CROSS-COMPILER-EXT (VOCABULARY)
...
: [CROSS-COMPILER-EXT] CROSS-COMPILER-EXT-WORDLIST  POSTPONE [WORDLIST]  ; IMMEDIATE
...
: 'CROSS-COMPILER-EXT  CROSS-COMPILER-EXT-WORDLIST  POSTPONE ['WORDLIST] ;
...
: CROSS-COMPILER-EXT-WORDS CROSS-COMPILER-EXT-WORDLIST .WORDLIST ;
