...
{ :NONAME 4 0 DO I 2 0 DO I J 1 > IF LEAVE THEN LOOP LOOP ; EXECUTE -> 0 0 1 1 0 1 2 0 3 0 }
{ :NONAME 4 0 DO I 2 0 DO I J 1 > IF EXIT  THEN LOOP LOOP ; EXECUTE -> 0 0 1 1 0 1 2 0 }
