...
RECORD: CROSS-COMPILER-TARGET-DESCRIPTION
    ...
    256 CHARS FIELD: TARGET-RUNTIME        \ main runtime routines
...
: SET-CROSS-COMPILER-TARGET-RUNTIME-FILE CROSS-COMPILER-TARGET TARGET-RUNTIME      SMOVE ;
...
: CROSS-COMPILER-TARGET-RUNTIME-FILE CROSS-COMPILER-TARGET TARGET-RUNTIME      COUNT ;
